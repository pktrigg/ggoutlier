...
def reportsummary(myreport, GGFindOutlierlogfilename):
	...
	myreport.addparagraph("The image above is a quick screenshot of the outliers relative to a hillshade of the input file.  It is designed to provide a visual summary of the outliers. The outliers are plotted as red crosses.")
	myreport.addparagraph("The outliers will most frequently be located at rocky outcrops so will be clustered. This is exactly as it should be. Stray, lonely outliers are the ones to closely analyse in GIS and CARIS to confirm if they are valid.")
	myreport.addspace()
	myreport.addspace()
	myreport.addspace()
